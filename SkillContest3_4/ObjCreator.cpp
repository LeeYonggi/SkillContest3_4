...
void ObjCreator::Init()
{
	...
	case STAGE_1:
	{
		...
		OBJECTMANAGER->AddObject(OBJ_ENEMY, new AirEnemy1(player, { 30, 10, 0 }));
		OBJECTMANAGER->AddObject(OBJ_ENEMY, new Rock(player, { 40, 0, 0 }));
...
{
	if (CAMERAMANAGER->mainCamera->eye.x > 400)
	{
